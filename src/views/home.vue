...
export default {
  ...
  methods: {
    ...
    editItem (item) {
      this.editedIndex = this.guardians.indexOf(item)
    ...
    deleteItemConfirm () {
      GuardiansApiService.delete(this.editedItem.id)
      this.guardians.splice(this.editedIndex, 1);
      this.closeDelete()
    },
